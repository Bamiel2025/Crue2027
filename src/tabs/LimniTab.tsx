...
function construireQuestions(): Question[] {
  ...
  return [
    ...
    },
    {
      ...
      st: "aubagne",
      type: "qcm",
      q: "Compare la crue du 10 mars 2024 (tempête Monica) à celle du 8 octobre 2024 (tempête Kirk), à Aubagne. Quelle affirmation est correcte ?",
      options: [
        "La crue du 10 mars monte plus vite mais moins haut que celle du 8 octobre",
        "La crue du 10 mars monte plus lentement, moins haut, mais dure beaucoup plus longtemps",
        "La crue du 10 mars est plus haute et plus rapide que celle du 8 octobre",
        "Les deux crues sont identiques",
      ],
      ok: 1,
      expl: `Crue du 10 mars 2024 (tempête Monica) : pic à ${fr(mAub.pic)} m, temps de montée ≈ ${fmtDuree(mAub.tempsMontee)}, décrue étalée sur plus d’une journée. Crue du 8 octobre 2024 (tempête Kirk) : pic à ${fr(kAub.pic)} m en ≈ ${fmtDuree(kAub.tempsMontee)}. Une pluie longue et modérée donne une crue lente et volumineuse ; un orage intense donne une crue éclair.`,
